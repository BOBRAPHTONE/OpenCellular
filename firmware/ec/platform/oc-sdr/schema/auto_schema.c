...
SCHEMA_IMPORT bool alert_log(void *driver, void *params);
#if 0
SCHEMA_IMPORT bool power_log(void *driver, void *params);
SCHEMA_IMPORT bool bms_log(void *driver, void *params);
SCHEMA_IMPORT bool hci_log(void *driver, void *params);
SCHEMA_IMPORT bool eth_log(void *driver, void *params);
SCHEMA_IMPORT bool gpp_log(void *driver, void *params);
SCHEMA_IMPORT bool sdr_log(void *driver, void *params);
SCHEMA_IMPORT bool rffe_log(void *driver, void *params);
SCHEMA_IMPORT bool sync_log(void *driver, void *params);
#endif
