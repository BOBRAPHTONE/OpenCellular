 ...
 **
 **    ARGUMENTS       : spi device configuration, command buffer, register value,
 **                      page offset, numOfBytes to be read, command write count.
 **
 ...
 **
 **    ARGUMENTS       : spi device configuration, command buffer, register value,
 **                      page offset, numOfBytes to be written, command write count.
 **
 **    RETURN TYPE     : Success or failure
 **
 *****************************************************************************/
 ...
 **
 **    DESCRIPTION     : Reads status of at45db device whether it is ready for r/w operation
 **
 ...
 **
 **    ARGUMENTS       : spi device configuration, data pointer, data size, page offset, page number
 **
 **    RETURN TYPE     : Success or failure
 **
 *****************************************************************************/
